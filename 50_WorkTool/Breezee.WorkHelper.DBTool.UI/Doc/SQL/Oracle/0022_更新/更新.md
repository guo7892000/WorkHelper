...
MERGE INTO T_PA_BU_OEM_PRE_STORE UD
   ...
   WHEN MATCHED THEN
     UPDATE
        SET UD.FROZEN_STOCK_QTY       = UD.FROZEN_STOCK_QTY +  DECODE(P_STOCK_UP_AREA,'1', FR.STOCK_UP_QTY, 0),
            UD.STOCK_UP_FROZEN_QTY    = UD.STOCK_UP_FROZEN_QTY + DECODE(P_STOCK_UP_AREA, '1', FR.STOCK_UP_QTY, 0),
            UD.MODIFIER               = 'SYSTEM',
