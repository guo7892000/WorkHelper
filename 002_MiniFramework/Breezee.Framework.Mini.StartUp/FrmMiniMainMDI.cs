...
namespace Breezee.Framework.Mini.StartUp
{
    ...
    /// 创建作者：黄国辉
    /// </summary>
    public partial class FrmMiniMainMDI : Form, IMainForm
    {
        #region 变量
        ...
        {
            Text = string.Format("工作助手（Work Helper） v{0} 正式版  2023-03-10", Assembly.GetExecutingAssembly().GetName().Version.ToString());
            ...
            GlobalContext.Instance.MenuHelpList.Add(new EntMenuHelp("/Help/Html/Mini/ChangeHistory.html", _FrameworkHelpName + " > 变更历史", _FrameworkHelpName));
            //加载菜单
            LoadMenu();
            //增加快捷菜单
            LoadShortCutMenu();
        ...
        private void AddMenuClassItem(ToolStripMenuItem tmiParent, ToolStripMenuItem tmiNew, DMenu dParentMenu)
        {
            ...
            foreach (DMenu childMenu in dParentMenu.ChildMenu)
            {
                ...
                else
                {
                    ...
                    {
                        GlobalContext.Instance.MenuHelpList.Add(new EntMenuHelp(childMenu.HelpPath, childMenu.FullPath, childMenu.Name));
                    }
                }
            }
        }
        ...
        private void OpenMenu(DMenu dMenu, bool IsExpandTreeNode = true)
        {
            ...
            foreach (Form frm in this.MdiChildren)
            {
                ...
                if (dMenuFrm.Guid.Equals(dMenu.Guid))
                {
                    ...
                    pnlDestop.Hide();
                    frm.Activate();
                    GlobalContext.Instance.CurrentForm = frm;
                    return;
                }
            }
            //反射得到窗体
            ...
            if (form is Form)
            {
                ...
                newForm.Show();
                GlobalContext.Instance.CurrentForm = newForm;
                txbMenuPath.BackColor = txbMenuPath.Parent.BackColor;
                //给窗体加上统一显示提示信息事件委托
        ...
        private void OpenTreeNodeMenu(string strSearchMenu)
        {
            ...
            foreach (TreeNode xn in tvLeftMenu.Nodes)
            {
                ...
                if (tnFind != null)
                {
                    ...
                    OpenMenu(tnFind.Tag as DMenu, false);//打开菜单
                    break;
                }
            }
        }  
        ...
        private void TsbHelp_Click(object sender, EventArgs e)
        {
            ...
            {
                DMenu curMenu = tpSelect.Tag as DMenu;
        ...
        {
            GlobalContext.Instance.CurrentForm.Close();
        }
