...
namespace Breezee.WorkHelper.DBTool.UI
{
    ...
    {
        private ICustomDataAccess CustomDataAccess;
        public AutoEntityBiz(DataBaseType dbt,DbServerInfo server)
        {
            CustomDataAccess = ContainerContext.Container.Resolve<ICustomDataAccess>();
        }
        ...
        {
            return CustomDataAccess.DataAccess.GetSchema(collectionName, restrictionValues);
        } 
        #endregion
